...
class MetalDetectorTests: XCTestCase {
    ...
    func testGoogleNetOnCat() {
        ...
        checkMetrics("conv1_7x7_s2", L1: 26894028, err1: 7E-5, L2: 7389178368, err2: 2E-4)
        checkMetrics("pool1_3x3_s2", L1: 15706585, err1: 1E-5, L2: 5238782464, err2: 2E-5)
        checkMetrics("pool1_norm1", L1: 6763517, err1: 1E-5, L2: 470019456, err2: 2E-5)
        checkMetrics("conv2_3x3_reduce", L1: 4607045, err1: 1E-5, L2: 365177216, err2: 2E-5)
        checkMetrics("conv2_3x3", L1: 6190394, err1: 1E-5, L2: 651581568, err2: 2E-5)
        checkMetrics("conv2_norm2", L1: 4979390.500000, err1: 1E-5, L2: 350693696, err2: 2E-5)
        checkMetrics("pool2_3x3_s2", L1: 3983016, err1: 1E-5, L2: 300735104, err2: 2E-5)
        checkMetrics("inception_3a_1x1", L1: 1376699, err1: 1E-5, L2: 133712880, err2: 2E-5)
        checkMetrics("inception_3a_3x3_reduce", L1: 1716600.250000, err1: 1E-5, L2: 141276912, err2: 2E-5)
        checkMetrics("inception_3a_3x3", L1: 2320588.250000, err1: 1E-5, L2: 287686272, err2: 2E-5)
        checkMetrics("inception_3a_5x5_reduce", L1: 418858.343750, err1: 1E-5, L2: 37575728, err2: 2E-5)
        checkMetrics("inception_3a_5x5", L1: 697953.750000, err1: 1E-5, L2: 80932752, err2: 2E-5)
        checkMetrics("inception_3a_pool", L1: 8837156, err1: 1E-5, L2: 766142080, err2: 2E-5)
        checkMetrics("inception_3a_pool_proj", L1: 460720.125000, err1: 2E-5, L2: 39634208, err2: 2E-5)
        checkMetrics("inception_3a_output", L1: 4855965, err1: 1E-5, L2: 541964032, err2: 2E-5)
        checkMetrics("inception_3b_output", L1: 2070707.625000, err1: 1E-5, L2: 173486784, err2: 2E-5)
        checkMetrics("inception_4a_output", L1: 803036.125000, err1: 1E-5, L2: 76048768, err2: 2E-5)
        checkMetrics("inception_4b_output", L1: 1172061, err1: 1E-5, L2: 77093112, err2: 2E-5)
        checkMetrics("inception_4c_output", L1: 907352.500000, err1: 1E-5, L2: 62197672, err2: 2E-5)
        checkMetrics("inception_4d_output", L1: 464165.843750, err1: 2E-5, L2: 27689768, err2: 3E-5)
